...
import { Body, ClassSerializerInterceptor, Controller, Delete, Get, Param, Put, Query, UseGuards, UseInterceptors } from '@nestjs/common';
...
export class AdminController {
    ...
    async getAllUsers(
       ...
       const {users, pagination}  = await this.adminService.getAllUsers(pageSize, page)
        return {
